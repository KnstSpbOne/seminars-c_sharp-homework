...
void Task19()
{
    ...
    string? Rslt="  Это";
    while ((UserInput.Length<2)|(UserInput is null))
    {
    ...
    {
        if (UserInput[cntr]==UserInput[(UserInput.Length-1)-cntr])
            Rslt=string.Concat(Rslt," палиндром");
        else
        {
            Rslt=string.Concat(Rslt," не палиндром");
            cntr=UserInput.Length/2;        
        }
    }
